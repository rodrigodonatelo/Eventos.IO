...
using Eventos.IO.Domain.Organzadores;
...
namespace Eventos.IO.Domain.Eventos
{
    public class Evento : Entity<Evento>
    {
        ...
        {
            public static Evento NovoEventoCompleto(Guid id, string nome, string descCurta, string descLonga, DateTime dataInicio, DateTime dataFim, bool gratuito, decimal valor, bool online, string nomeEmpresa, Guid? orgainzadorId )
            {
                ...
                if(orgainzadorId != null)
                    evento.Organizador = new Organizador(orgainzadorId.Value);
